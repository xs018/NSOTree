...
if __name__ == "__main__":
    ...
    model = NOTree(input_dim=input_dim, output_dim=output_dim, hidden_dim=hidden_dim, num_layer=depth, num_back_layer=back_n, dense=True, drop_type=drop_type, net_type=net_type, approx=anneal).cuda()
    print(model)
